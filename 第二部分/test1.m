...
fill(position(34:233,1),position(34:233,2),[0,0,0]);
...
v1=zeros(22,2);  %13个中点加上起始点和终止点                         %v1存放包括S和T的总共22个结点，作为DijkstraPlan的参数
v1(1,:)=[0,0];
v1(22,:)=[100,100];
for i=2:21
    v1(i,:)=v(i-1,:);
